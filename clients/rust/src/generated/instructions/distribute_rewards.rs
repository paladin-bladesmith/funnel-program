...
pub struct DistributeRewards {
    ...
    pub treasury_account: solana_program::pubkey::Pubkey,

    pub paladin_stake_program: solana_program::pubkey::Pubkey,

    pub stake_config_account: solana_program::pubkey::Pubkey,

    pub paladin_rewards_program: solana_program::pubkey::Pubkey,

    pub holder_rewards_pool_account: solana_program::pubkey::Pubkey,
...
impl DistributeRewards {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            self.holder_rewards_pool_account,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
            self.token_mint,
...
///   1. `[writable]` treasury_account
///   2. `[]` paladin_stake_program
///   3. `[writable]` stake_config_account
///   4. `[]` paladin_rewards_program
///   5. `[writable]` holder_rewards_pool_account
///   6. `[]` token_mint
...
pub struct DistributeRewardsBuilder {
    ...
    treasury_account: Option<solana_program::pubkey::Pubkey>,
    paladin_stake_program: Option<solana_program::pubkey::Pubkey>,
    stake_config_account: Option<solana_program::pubkey::Pubkey>,
    paladin_rewards_program: Option<solana_program::pubkey::Pubkey>,
    holder_rewards_pool_account: Option<solana_program::pubkey::Pubkey>,
...
impl DistributeRewardsBuilder {
    ...
    pub fn treasury_account(
        &mut self,
        treasury_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.treasury_account = Some(treasury_account);
        self
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn stake_config_account(
        &mut self,
        stake_config_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.stake_config_account = Some(stake_config_account);
        self
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn holder_rewards_pool_account(
        &mut self,
        holder_rewards_pool_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
        self.holder_rewards_pool_account = Some(holder_rewards_pool_account);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DistributeRewards {
            ...
            treasury_account: self.treasury_account.expect("treasury_account is not set"),
            paladin_stake_program: self
                .paladin_stake_program
                .expect("paladin_stake_program is not set"),
            stake_config_account: self
                .stake_config_account
                .expect("stake_config_account is not set"),
            paladin_rewards_program: self
                .paladin_rewards_program
                .expect("paladin_rewards_program is not set"),
            holder_rewards_pool_account: self
                .holder_rewards_pool_account
                .expect("holder_rewards_pool_account is not set"),
...
pub struct DistributeRewardsCpiAccounts<'a, 'b> {
    ...
    pub treasury_account: &'b solana_program::account_info::AccountInfo<'a>,

    pub paladin_stake_program: &'b solana_program::account_info::AccountInfo<'a>,

    pub stake_config_account: &'b solana_program::account_info::AccountInfo<'a>,

    pub paladin_rewards_program: &'b solana_program::account_info::AccountInfo<'a>,

    pub holder_rewards_pool_account: &'b solana_program::account_info::AccountInfo<'a>,
...
impl<'a, 'b> DistributeRewardsCpi<'a, 'b> {
    pub fn new(
        ...
        Self {
            ...
            stake_config_account: accounts.stake_config_account,
            paladin_rewards_program: accounts.paladin_rewards_program,
            holder_rewards_pool_account: accounts.holder_rewards_pool_account,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(
            *self.holder_rewards_pool_account.key,
            false,
        ));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(
            *self.token_mint.key,
        ...
        account_infos.push(self.treasury_account.clone());
        account_infos.push(self.paladin_stake_program.clone());
        account_infos.push(self.stake_config_account.clone());
        account_infos.push(self.paladin_rewards_program.clone());
        account_infos.push(self.holder_rewards_pool_account.clone());
...
impl<'a, 'b> DistributeRewardsCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DistributeRewardsCpiBuilderInstruction {
            ...
            stake_config_account: None,
            paladin_rewards_program: None,
            holder_rewards_pool_account: None,
            token_mint: None,
            system_program: None,
            amount: None,
    ...
    pub fn treasury_account(
        &mut self,
        treasury_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.treasury_account = Some(treasury_account);
        self
    }
    #[inline(always)]
    pub fn paladin_stake_program(
    ...
    pub fn stake_config_account(
        &mut self,
        stake_config_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.stake_config_account = Some(stake_config_account);
        self
    }
    #[inline(always)]
    pub fn paladin_rewards_program(
    ...
    pub fn holder_rewards_pool_account(
        &mut self,
        holder_rewards_pool_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.holder_rewards_pool_account = Some(holder_rewards_pool_account);
        self
    }
    #[inline(always)]
    pub fn token_mint(
    ...
    pub fn invoke_signed(
        ...
        let instruction = DistributeRewardsCpi {
            ...
            treasury_account: self
                .instruction
                .treasury_account
                .expect("treasury_account is not set"),
...
struct DistributeRewardsCpiBuilderInstruction<'a, 'b> {
    ...
    treasury_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    paladin_stake_program: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    stake_config_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    paladin_rewards_program: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    holder_rewards_pool_account: Option<&'b solana_program::account_info::AccountInfo<'a>>,
